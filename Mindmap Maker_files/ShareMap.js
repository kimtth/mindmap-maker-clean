mindmaps.ShareMapView = function () {
	...
	//var doc = mindmaps.getDocument();
		...
		var url = encodeURIComponent(mindmaps.Config.BaseUrl + '#m:' + mindmaps.currentMapId);
			...
			$("#share-button-facebook").attr("href", 'https://www.facebook.com/dialog/feed?app_id=2089881701274718&' +
					'link=' + url + '&' +
					'name=' + docTitle + '&' +
					'caption=' + encodeURIComponent('Mind map from mindmapmaker.org') + '&' +
					'picture=' + encodeURIComponent('http://mindmapmaker.org/mind-map-maker.png') + '&' +
					'description=' + docTitle + '&' +
					'redirect_uri=' + encodeURIComponent('https://app.mindmapmaker.org'));
